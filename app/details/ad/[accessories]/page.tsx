	...
	return (
		<div>
			<div className="flex justify-center">
				<div className="flex flex-wrap justify-center lg:w-7/12">
					<Image
						src={product.url}
						width={550}
						height={500}
					...
					<div className="grow">
						...
						<div className="flex justify-between py-6 px-4 mb-2 mx-2 border-2 rounded-xl">
							<div className="flex flex-col justify-between py-2 font-semibold gap-2">
								...
								{product.interface ? (
									<p className="text-sm">Interface: {product.interface}</p>
								) : null}

								{product.capacity ? (
									<p className="text-sm">Capacity: {product.capacity} GB</p>
								) : null}
