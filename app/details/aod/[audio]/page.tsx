					...
					<div className="grow">
						...
						<div className="flex justify-between py-6 px-4 mb-2 mx-2 border-2 rounded-xl">
							<div className="flex flex-col justify-between py-2 font-semibold gap-2">
								<p className="text-sm">Comunication: {product.comunication}</p>
								<p className="text-sm">Microphone: {product.microphone}</p>
								<p className="text-sm">Noise cancelling: {product.anc}</p>
							</div>
